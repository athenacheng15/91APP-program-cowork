...
function PopUp({title,content,buttonText,buttonFunction}:PopUpProps) {
	return ( 
		<section className="bg-white fixed top-[45%] self-center w-[290px] h-[165px] rounded-md flex flex-col items-center justify-center">
			<div className="text-[16px] font-[500] my-[18.5px]">{title}</div>
			<div className="text-[13px] mb-[30px]">{content}</div>
			<div className="w-[90%] h-[40px] cursor-pointer bg-[#fe494e] rounded-md flex items-center justify-center">
