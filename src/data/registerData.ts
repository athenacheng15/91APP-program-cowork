...
// add stock later
export const iPhoneColorList=[{name:"粉紅色",color:"#FAE1DC"},{name:"藍色",color:"#3d6c85"},{name:"午夜色",color:"#3b3f44"},{name:"星光色",color:"#faf6f3"},{name:"熱情紅",color:"#b67f80"},{name:"湖水綠",color:"#aad5c2"},{name:"天峰藍",color:"#a6bfd6"},{name:"金色",color:"#f9e7cf"},{name:"石墨色",color:"#585755"}];
export const priceChart=[{type:"iPhone 13", size:"128GB", price:"25,900"},{type:"iPhone 13", size:"256GB", price:"29,400"},{type:"iPhone 13", size:"512GB", price:"36,400"},{type:"iPhone 13 Pro", size:"128GB", price:"32,900"},{type:"iPhone 13 Pro", size:"256GB", price:"36,400"},{type:"iPhone 13 Pro", size:"512GB", price:"43,400"},{type:"iPhone 13 Pro", size:"1TB", price:"50,400"}];
export const sizeList=[{name:"128GB"},{name:"256GB"},{name:"512GB"},{name:"1TB"}];
